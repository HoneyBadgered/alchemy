...
const footerLinks = {
  ...
  account: [
    { href: '/account', label: 'Sign In / Sign Up' },
...
/**
 * Site footer component with navigation links, social links, and legal information.
 * All links are functional and route to implemented pages.
 */
        ...
        <div className="border-t border-purple-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-purple-300 text-sm">
              © {currentYear} The Alchemy Table. All rights reserved.
            </p>
          </div>
        </div>
      </div>
